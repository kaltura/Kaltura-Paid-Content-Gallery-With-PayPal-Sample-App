...
class pptransact{
	...
	public function getToken($userId, $itemId, $qty ,$mobile) {
        ...
        $postDetails = array('USER' => UID,
                             ...
                             'VERSION' => VER,
                             'PAYMENTREQUEST_0_CURRENCYCODE' => $itemObj['currency'],
                             'PAYMENTREQUEST_0_AMT' => $itemObj['qty'] * $itemObj['amt'] + $tax,
        					 'PAYMENTREQUEST_0_ITEMAMT' => $itemObj['qty'] * $itemObj['amt'],
                             'PAYMENTREQUEST_0_TAXAMT' => $tax,
                             'PAYMENTREQUEST_0_DESC' => $itemObj['name'],
